...
class CreateScReportCardJuniorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sc_report_card_juniors', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sc_report_card_juniors');
    }
}
